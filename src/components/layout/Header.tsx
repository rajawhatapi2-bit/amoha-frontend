    ...
    <header className="sticky top-0 z-50 border-b border-gray-200 bg-white/95 backdrop-blur-2xl dark:border-white/5 dark:bg-primary-950/95">
      ...
      <div className="border-b border-gray-100 bg-gray-50/80 dark:border-white/5 dark:bg-primary-950/80">
        <div className="page-container flex items-center justify-between py-1.5 text-xs text-gray-500 dark:text-gray-400">
          ...
          <span className="hidden sm:inline">📞 Support: +91 98765 43210</span>
        </div>
      </div>
        ...
        <div className="flex h-14 items-center gap-4 sm:h-16">
          ...
          <Link href="/" prefetch={true} className="flex flex-shrink-0 items-center gap-2">
            ...
            <div className="hidden sm:block">
              ...
              <p className="text-[10px] -mt-1 font-medium italic text-gray-500 dark:text-gray-400 dark:text-gray-500">Explore <span className="text-primary-400">Plus</span></p>
            </div>
          </Link>
          ...
          <div className="ml-auto flex items-center gap-0.5 sm:gap-1">
            ...
            <button
              ...
              className="rounded-lg p-2 text-gray-500 transition-colors hover:bg-gray-100 hover:text-gray-900 dark:text-gray-400 dark:hover:bg-white/5 dark:hover:text-gray-900 dark:hover:text-white lg:hidden"
            >
            ...
            <Link
              ...
              className={`hidden sm:flex items-center gap-1.5 rounded-lg px-3 py-2 text-sm font-medium transition-all ${
                pathname === '/products' || pathname.startsWith('/products?')
                  ...
                  : 'text-gray-500 hover:bg-gray-100 hover:text-gray-900 dark:text-gray-400 dark:hover:bg-white/5 dark:hover:text-gray-900 dark:hover:text-white'
              }`}
            >
            ...
            <Link
              href="/wishlist"
              prefetch={true}
              className="relative rounded-lg p-2 text-gray-500 transition-colors hover:bg-gray-100 hover:text-gray-900 dark:text-gray-400 dark:hover:bg-white/5 dark:hover:text-gray-900 dark:hover:text-white"
            >
            ...
            <div className="relative">
              <button
                ...
                className="flex items-center gap-1.5 rounded-lg px-2 py-2 text-gray-500 transition-colors hover:bg-gray-100 hover:text-gray-900 dark:text-gray-400 dark:hover:bg-white/5 dark:hover:text-gray-900 dark:hover:text-white sm:px-3"
              >
              ...
              {isProfileOpen && (
                <>
                  ...
                  <div className="absolute right-0 top-full z-50 mt-2 w-52 overflow-hidden rounded-xl border border-gray-200 bg-white shadow-lg dark:border-white/10 dark:bg-surface-100/95 dark:shadow-glass dark:backdrop-blur-xl">
                    ...
                    <div className="py-1">
                      <Link href="/profile" onClick={() => setIsProfileOpen(false)} className="flex items-center gap-2.5 px-3 py-2.5 text-sm text-gray-600 transition-colors hover:bg-gray-50 hover:text-gray-900 dark:text-gray-400 dark:hover:bg-white/5 dark:hover:text-gray-900 dark:hover:text-white">
                        <HiOutlineUser className="h-4 w-4" /> My Profile
                      </Link>
                      <Link href="/orders" onClick={() => setIsProfileOpen(false)} className="flex items-center gap-2.5 px-3 py-2.5 text-sm text-gray-600 transition-colors hover:bg-gray-50 hover:text-gray-900 dark:text-gray-400 dark:hover:bg-white/5 dark:hover:text-gray-900 dark:hover:text-white">
                        <HiOutlineClipboardList className="h-4 w-4" /> My Orders
                      </Link>
                      <Link href="/wishlist" onClick={() => setIsProfileOpen(false)} className="flex items-center gap-2.5 px-3 py-2.5 text-sm text-gray-600 transition-colors hover:bg-gray-50 hover:text-gray-900 dark:text-gray-400 dark:hover:bg-white/5 dark:hover:text-gray-900 dark:hover:text-white">
            ...
            <button
              ...
              className="rounded-lg p-2 text-gray-500 transition-colors hover:bg-gray-100 hover:text-gray-900 dark:text-gray-400 dark:hover:bg-white/5 dark:hover:text-gray-900 dark:hover:text-white sm:hidden"
            >
